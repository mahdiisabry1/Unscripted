      ...
      <div className="mt-6 mb-6 w-full grid grid-cols-1 md:grid-cols-[1fr_2fr_1fr] lg:grid-cols-[1fr_2fr_1fr] gap-2">
        <div className="hidden md:grid grid-rows-2 gap-1 h-full">
          <div className="relative group aspect-video">
            ...
            <div className="absolute bottom-0 p-4">
              ...
              <p className="text-slate-200 text-sm mt-3 max-h-0 font-extrabold overflow-hidden group-hover:max-h-40 transition-all duration-700">
        ...
        <div className="grid grid-rows-1 gap-1 h-full relative group aspect-video">
          ...
          <div className="absolute bottom-0 p-4">
            <Link
              to="/test"
              className="text-white font-extrabold md:text-2xl lg:text-3xl cursor-pointer hover:underline mb-1 text-justify"
            >
            ...
            <p className="text-slate-200 text-sm mt-3 max-h-0 font-extrabold overflow-hidden group-hover:max-h-40 transition-all duration-1000">
              <h1 className="text-justify">
                ...
                accusamus, ex reiciendis corrupti quos labore illo vitae! Libero
                facilis vero suscipit eos in, ipsum placeat maiores veniam amet
                dolores tempore omnis blanditiis molestias labore.
              </h1>
            </p>
          </div>
        </div>
